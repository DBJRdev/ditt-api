...
class WorkMonthServiceCest
{
    ...
    public function testCalculateNoWorkLogs(\UnitTester $I): void
    {
        ...
        $service = $this->getWorkMonthService($prophet, [], [], [], [], [], [], [], [], [], [], [], $contracts);
    ...
    public function testCalculateShortStandardWorkLogsWithoutBreak(\UnitTester $I): void
    {
        ...
        $service = $this->getWorkMonthService($prophet, [], [], [], [], [], [], [], [], [], [], $workLogs, $contracts);
    ...
    public function testCalculateBanWorkLogWithShortStandardWorkLogsWithoutBreak(\UnitTester $I): void
    {
        ...
        $service = $this->getWorkMonthService($prophet, $banWorkLogs, [], [], [], [], [], [], [], [], [], $workLogs, $contracts);
    ...
    public function testCalculateApprovedHomeOfficeWorkLogsWithoutWorkLogs(\UnitTester $I): void
    {
        ...
        $service = $this->getWorkMonthService($prophet, [], [], $homeOfficeWorkLogs, [], [], [], [], [], [], [], [], $contracts);
    ...
    public function testCalculateApprovedHomeOfficeWorkLogsWithoutBreak(\UnitTester $I): void
    {
        ...
        $service = $this->getWorkMonthService($prophet, [], [], $homeOfficeWorkLogs, [], [], [], [], [], [], [], $workLogs, $contracts);
    ...
    public function testCalculateMaternityProtectionWorkLogsWithoutWorkLogs(\UnitTester $I): void
    {
        ...
        $service = $this->getWorkMonthService($prophet, [], [], [], $maternityProtectionWorkLogs, [], [], [], [], [], [], [], $contracts);
    ...
    public function testCalculateMaternityProtectionWorkLogsWithoutBreak(\UnitTester $I): void
    {
        ...
        $service = $this->getWorkMonthService($prophet, [], [], [], $maternityProtectionWorkLogs, [], [], [], [], [], [], $workLogs, $contracts);
    ...
    public function testCalculateParentalLeaveWorkLogsWithoutWorkLogs(\UnitTester $I): void
    {
        ...
        $service = $this->getWorkMonthService($prophet, [], [], [], [], $parentalLeaveWorkLogs, [], [], [], [], [], [], $contracts);
    ...
    public function testCalculateParentalLeaveWorkLogsWithoutBreak(\UnitTester $I): void
    {
        ...
        $service = $this->getWorkMonthService($prophet, [], [], [], [], $parentalLeaveWorkLogs, [], [], [], [], [], $workLogs, $contracts);
    ...
    public function testCalculateSickDayWorkLogsWithoutWorkLogs(\UnitTester $I): void
    {
        ...
        $service = $this->getWorkMonthService($prophet, [], [], [], [], [], $sickDayWorkLogs, [], [], [], [], [], $contracts);
    ...
    public function testCalculateApprovedTimeOffWorkLogsWithoutWorkLogs(\UnitTester $I): void
    {
        ...
        $service = $this->getWorkMonthService($prophet, [], [], [], [], [], [], [], $timeOffWorkLogs, [], [], [], $contracts);
    ...
    public function testCalculateApprovedTimeOffWorkLogsWithoutBreak(\UnitTester $I): void
    {
        ...
        $service = $this->getWorkMonthService($prophet, [], [], [], [], [], [], [], $timeOffWorkLogs, [], [], $workLogs, $contracts);
    ...
    // Training trip work logs

    /**
     * @throws \Exception
     */
    public function testCalculateApprovedTrainingWorkLogsWithoutWorkLogs(\UnitTester $I): void
    {
        $prophet = new Prophet();
        $workMonth = $this->getWorkMonth($prophet);
        $contracts = [$this->getContract($prophet)];
        ...
        $service = $this->getWorkMonthService($prophet, [], $trainingWorkLogs, [], [], [], [], [], [], [], [], [], $contracts);
     ...
     * @throws \Exception
     */
    public function testCalculateUnapprovedTrainingWorkLogsWithoutWorkLogs(\UnitTester $I): void
    {
        $prophet = new Prophet();
        $workMonth = $this->getWorkMonth($prophet);
        $contracts = [$this->getContract($prophet)];
     ...
     * @throws \Exception
     */
    public function testCalculateApprovedTrainingWorkLogsWithoutBreak(\UnitTester $I): void
    {
        $prophet = new Prophet();
        $workMonth = $this->getWorkMonth($prophet);
        $contracts = [$this->getContract($prophet)];
        ...
        $service = $this->getWorkMonthService($prophet, [], $trainingWorkLogs, [], [], [], [], [], [], [], [], $workLogs, $contracts);
     ...
     * @throws \Exception
     */
    public function testCalculateApprovedTrainingWorkLogsWithLongBreak(\UnitTester $I): void
    {
        $prophet = new Prophet();
        $workMonth = $this->getWorkMonth($prophet);
        $contracts = [$this->getContract($prophet)];
     ...
     * @throws \Exception
     */
    public function testCalculateApprovedTrainingWorkLogsWithOneStandardWorkLogMoreThan6HoursLong(\UnitTester $I): void
    {
        $prophet = new Prophet();
        $workMonth = $this->getWorkMonth($prophet);
        $contracts = [$this->getContract($prophet)];
     ...
     * @throws \Exception
     */
    public function testCalculateApprovedTrainingWorkLogsAboveLowerLimitWithoutBreak(\UnitTester $I): void
    {
        $prophet = new Prophet();
        $workMonth = $this->getWorkMonth($prophet);
        $contracts = [$this->getContract($prophet)];
     ...
     * @throws \Exception
     */
    public function testCalculateApprovedTrainingWorkLogsAboveLowerLimitWithShortBreak(\UnitTester $I): void
    {
        $prophet = new Prophet();
        $workMonth = $this->getWorkMonth($prophet);
        $contracts = [$this->getContract($prophet)];
     ...
     * @throws \Exception
     */
    public function testCalculateApprovedTrainingWorkLogsAboveLowerLimitWithLongBreak(\UnitTester $I): void
    {
        $prophet = new Prophet();
        $workMonth = $this->getWorkMonth($prophet);
        $contracts = [$this->getContract($prophet)];
     ...
     * @throws \Exception
     */
    public function testCalculateApprovedTrainingWorkLogsAboveMediumLimitWithoutBreak(\UnitTester $I): void
    {
        $prophet = new Prophet();
        $workMonth = $this->getWorkMonth($prophet);
        $contracts = [$this->getContract($prophet)];
     ...
     * @throws \Exception
     */
    public function testCalculateApprovedTrainingWorkLogsAboveMediumLimitWithShortBreak(\UnitTester $I): void
    {
        $prophet = new Prophet();
        $workMonth = $this->getWorkMonth($prophet);
        $contracts = [$this->getContract($prophet)];
     ...
     * @throws \Exception
     */
    public function testCalculateApprovedTrainingWorkLogsAboveMediumLimitWithLongBreak(\UnitTester $I): void
    {
        $prophet = new Prophet();
        $workMonth = $this->getWorkMonth($prophet);
        $contracts = [$this->getContract($prophet)];
     ...
     * @throws \Exception
     */
    public function testCalculateApprovedTrainingWorkLogsAboveUpperLimitWithoutBreak(\UnitTester $I): void
    {
        $prophet = new Prophet();
        $workMonth = $this->getWorkMonth($prophet);
        $contracts = [$this->getContract($prophet)];
     ...
     * @throws \Exception
     */
    public function testCalculateApprovedTrainingWorkLogsAboveUpperLimitWithShortBreak(\UnitTester $I): void
    {
        $prophet = new Prophet();
        $workMonth = $this->getWorkMonth($prophet);
        $contracts = [$this->getContract($prophet)];
     ...
     * @throws \Exception
     */
    public function testCalculateApprovedTrainingWorkLogsAboveUpperLimitWithLongBreak(\UnitTester $I): void
    {
        $prophet = new Prophet();
        $workMonth = $this->getWorkMonth($prophet);
        $contracts = [$this->getContract($prophet)];
    ...
    public function testCalculateApprovedVacationWorkLogsWithoutWorkLogs(\UnitTester $I): void
    {
        ...
        $service = $this->getWorkMonthService($prophet, [], [], [], [], [], [], [], [], [], $vacationWorkLogs, [], $contracts);
    ...
    public function testCalculateApprovedVacationWorkLogsWithoutBreak(\UnitTester $I): void
    {
        ...
        $service = $this->getWorkMonthService($prophet, [], [], [], [], [], [], [], [], [], $vacationWorkLogs, $workLogs, $contracts);
    ...
    private function getContract(Prophet $prophet): Contract
    {
        /** @var Contract $contract */
        $contract = $prophet->prophesize(Contract::class);
        $contract->getIsDayBased()->willReturn(false);
        $contract->getIsMondayIncluded()->willReturn(false);
        $contract->getIsTuesdayIncluded()->willReturn(false);
        $contract->getIsWednesdayIncluded()->willReturn(false);
        $contract->getIsThursdayIncluded()->willReturn(false);
        $contract->getIsFridayIncluded()->willReturn(false);
        $contract->getWeeklyWorkingHours()->willReturn(30);
        $contract->getWeeklyWorkingDays()->willReturn(5);
        $contract->getStartDateTime()->willReturn(new \DateTimeImmutable('2018-01-01 00:00:00'));
        $contract->getEndDateTime()->willReturn(null);
    ...
    private function getContractRepository(Prophet $prophet, array $contracts): ContractRepository
    {
        $repository = $prophet->prophesize(ContractRepository::class);
        $repository->findContractsBetweenDates(
    ...
    private function getWorkMonthService(
        ...
        return new WorkMonthService(
            ...
            $this->getContractRepository($prophet, $contracts),
